...
/***/ function(module, exports, __webpack_require__) {
	...
	// console.log('EncryptedUri: ', encryptedHls);
	//
	// console.log('DecryptedUri: ', _getEncryptedUri());
	...
	player.markers({
	  ...
	  markers: [{ time: 0, text: "Velkommen til TV AVISEN 21:00", overlayText: 'TV AVISEN 21:00' }, { time: 300, text: "USA - Trump møder May", overlayText: 'USA - Trump møder May' }, { time: 600, text: "USA - Stemningen under pressemødet", overlayText: 'USA - Stemningen under pressemødet' }, { time: 900, text: "Bandepakke - Færre betjente jagter rockere", overlayText: 'Bandepakke - Færre betjente jagter rockere' }]
	});
